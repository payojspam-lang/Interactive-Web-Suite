...
const testimonials = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?q=80&w=100&auto=format&fit=crop",
    name: "Bilal Ahmed",
    role: "IT Manager",
  },
  {
...
export function TestimonialsDemo() {
  return (
    <section className="bg-background my-20 relative text-white">
      <div className="container z-10 mx-auto">
        ...
        >
          <div className="flex justify-center">
            <div className="border border-white/20 py-1 px-4 rounded-lg">Testimonials</div>
          </div>
