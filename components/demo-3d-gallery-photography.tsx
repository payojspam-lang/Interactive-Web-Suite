...
const sampleImages = [
  ...
  return (
    <main className="min-h-screen h-full w-full bg-black">
			...
			/>
			<div className="h-screen inset-0 pointer-events-none fixed flex items-center justify-center text-center px-3 text-white">
				<h1 className="font-serif text-4xl md:text-7xl tracking-tight font-bold drop-shadow-xl select-none">
					<span className="italic">G A L L E R Y</span>
				</h1>
			</div>

			<div className="text-center fixed bottom-10 left-0 right-0 font-mono text-[11px] font-semibold text-white/50 bg-black/50 py-2">
